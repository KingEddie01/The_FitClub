...
import {testimonialData, testimonialsData} from '../../data/testimonialsData'
...
const Testimonial = () => {
  ...
  return (
    <div id='testimonials' style={{display:'flex',gap:'1rem',padding:'0 2rem'}}>
      <div  className='testimony' style={{display:'flex',
            flex:'1 1',
            gap:'2rem',
      ...
      <div className='rightTest' style={{flex:'1',position:'relative'}}>
        <motion.div
          initial={{opacity:0,x:-100}}
